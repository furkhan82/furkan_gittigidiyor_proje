...
public class CreateCard2 extends TestBase {

    public Response response1;
    JsonPath jsonPath;

    @Given("kart olusturma 2 {string}")
    public void kart_olusturma_2(String cardName) {
        ...
        try {
            ...
            FileWriter fw = new FileWriter("C:/Users/furkan/Desktop/cardId2.txt");
